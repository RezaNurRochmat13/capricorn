...
<html lang="en">
  <head>
    ...
    <title> Sistem Informasi Capriorn Roller </title>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <?php echo validation_errors(); ?>
                      <form action="<?php echo site_url("produk/tambah_data_produk")?>" method="post">
                            ...
                            <div class=form-group-row>
                              <label for="example-text-input" class="col-xs-2 col-form-label">Nama Produk</label>
                                  <div class="col-xs-10">
                                     ...
                                     <input type="text" name="nama_produk" placeholder="Masukkan nama produk" class="form-control" value="<?php echo set_value('nama_produk')?>" required>
                                  </div>
                                </div>
                            </div>
                          </td>
                          ...
                          <td>
                            <div class="form-group-row">
                               <label for="example-text-input" class="col-xs-2 col-form-label">Harga Produk</label>
                                <div class="col-xs-10">
                                  <div class="right-inner-addon">
                                   <input type="number" name="harga_produk" class="form-control" placeholder="Masukkan harga produk" value="<?php echo set_value('harga_produk')?>" required>
                               </div> 
                              </div>
                            </div>
                            </td>
                          ...
                          <td>
                            <div class="form-group-row">
                               <label for="example-text-input" class="col-xs-2 col-form-label">Deskripsi Produk</label>
                                <div class="col-xs-10">
                                  <div class="right-inner-addon">
                                   <input type="text" name="deskripsi_produk" class="form-control" placeholder="Masukkan deskripsi produk" value="<?php echo set_value('deskripsi_produk')?>" required>
                               </div> 
                              </div>
                            </div>
                            </td>
                            ...
                            <td>
                              ...
                              <div class="col-xs-10">
                                  <div class="form-group">
                                        <select class="selectpicker form-control" name="id_promosi" id="barang" required>
                                        <?php 
                           ...
                           <tr>
                            <td>
                              ...
                              <div class="col-xs-10">
                                  <div class="form-group">
                                        <select class="selectpicker form-control" name="id_kategori_produk" id="barang" required>
                                        <?php 
