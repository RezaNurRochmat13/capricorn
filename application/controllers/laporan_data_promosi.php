...
class laporan_data_promosi extends CI_Controller{
	...
	public function index(){ //Function untuk menampilkan halaman laporan data promosi.

		$this->load->view('admin/view_laporan_data_promosi'); //Script untuk menampilkan laporan data promosi.
	}
