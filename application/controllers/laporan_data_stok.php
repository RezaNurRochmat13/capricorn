...
class laporan_data_stok extends CI_Controller{
	...
	public function index(){ //Fucntion untuk menampilkan halaman laporan data stok.

		$this->load->view('admin/view_laporan_data_stok'); //Script untuk menampilkan halaman laporan data stok.
