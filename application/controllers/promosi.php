...
class promosi extends CI_Controller{
	...
	/**Function untuk mendeklarasikan konstruktor seperti yang ada di Java.
	...
	public function index(){
		//Sebuah function untuk menampilkan halaman dari data promosi.

		$this->load->view('admin/view_promosi'); //Script untuk menampilkan halaman data promosi.
	}
}
