...
class laporan_data_produk extends CI_Controller{
	...
	public function index(){ //Function untuk menampilkan halaman laporan data produk.

		$this->load->view('admin/view_laporan_data_produk'); //Script untuk menampilkan halaman laporan data 
